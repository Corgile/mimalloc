...
#define MI_TRACK_TOOL         "MY_TRACK_TOOL"

/* 其余占位，避免编译警告  */
#define mi_track_resize(p,old,new)        ((void)0)
#define mi_track_mem_defined(p,s)         ((void)0)
#define mi_track_mem_undefined(p,s)       ((void)0)
#define mi_track_mem_noaccess(p,s)        ((void)0)
